    ...
    <div class="flex flex-1 items-center justify-center py-12">
        <section class="glass-panel w-full max-w-md rounded-[32px] p-8">
            <div class="mb-6 flex items-center gap-3">
                <img src="{{ asset('storage/icons/second.jpg') }}" alt="Najjar Group secondary icon" class="brand-icon">
            ...
            <form method="POST" action="{{ route('dashboard.login') }}" class="mt-6 space-y-4">
                ...
                <div>
                    ...
                    <input id="password" name="password" type="password" required autofocus class="brand-field w-full rounded-2xl border border-slate-200 bg-white/80 px-4 py-3 text-sm outline-none transition focus:border-amber-400 focus:ring-4 focus:ring-amber-200/70">
                </div>

                <button type="submit" class="brand-button w-full rounded-2xl bg-slate-950 px-5 py-3 text-sm font-semibold text-white transition hover:bg-slate-800">
